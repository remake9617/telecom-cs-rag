...
$base = "http://localhost:8080"   # 路6 容器实测：改走 VM 全栈 nginx 同源入口（原 localhost:8080 直连后端）
...
[IO.File]::WriteAllText("$PWD\test-data\q3.json", '{"question":"p11-我要投诉，网速太慢了，帮我转人工客服"}', (New-Object Text.UTF8Encoding $false))
